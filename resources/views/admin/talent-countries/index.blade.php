...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <div class="d-flex align-items-center gap-3">
        ...
        <div class="btn-group">
            <a href="{{ route('admin.export', ['resource' => 'talent-countries', 'format' => 'excel'] + request()->query()) }}" class="btn btn-outline-success" title="Export Excel">
                <i class="fas fa-file-excel"></i>
            </a>
            <a href="{{ route('admin.export', ['resource' => 'talent-countries', 'format' => 'pdf'] + request()->query()) }}" class="btn btn-outline-danger" title="Export PDF">
